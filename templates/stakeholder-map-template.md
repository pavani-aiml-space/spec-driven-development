*Browsing copy for showcase purposes. Canonical source (edit here, not this copy): [roles/tpm/tpm-stakeholder-map/examples/prescription-alternatives-example.md](../roles/tpm/tpm-stakeholder-map/examples/prescription-alternatives-example.md), part of the [tpm-stakeholder-map](../roles/tpm/tpm-stakeholder-map/SKILL.md) skill.*
